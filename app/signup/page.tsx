    ...
    <main className="flex gap-8 flex-col items-center bg-neutral-100 w-full h-auto  p-24">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleSubmit)} className='max-w-md border-2 p-4 rounded shadow-sm bg-white border-slate-100 w-full'>
          <h1 className='text-center text-xl mb-4 text-slate-700 font-bold'>Signup</h1>
          ...
          <div className='flex flex-col gap-4'>
            ...
            />
            <Button type='submit' className='max-w-md w-full flex flex-col  gap-4'>Sign Up</Button>
            <Link className="text-center" href="/">Already Have an Account? <span className='text-cyan-700'>Login</span></Link>
